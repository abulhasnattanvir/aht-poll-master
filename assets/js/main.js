jQuery(document).ready(function ($) {
    ...
    $('.option_answer').on('click', function () {
        ...
        $.ajax({
            url: ahtpoma_vars.ajaxurl,
            type: 'POST',
            data: {
                action: 'ahtpoma_vote',
                poll_id: poll_id,
                option_index: option_index,
                ahtpoma_vote_nonce: ahtpoma_vars.ahtpoma_vote_nonce
            },
            success: function (response) {
                if (response.success) {
                    ...
                    $('.option_answer[data-poll-id="' + poll_id + '"]').each(function () {
                        ...
                        var percent = response.data.votes_percent[index];
    ...
    // Animate bar heights (used on admin view page)
